...
import 'package:flutter_app/paryer_time/shadow_length.dart';
import 'package:flutter_app/paryer_time/utils/calendar_util.dart';
import 'package:flutter_app/paryer_time/utils/solar_time.dart';
...
class PrayerTimes {
  ...
  PrayerTimes(coordinates,dateComponents,calculationParameters){
    params(coordinates, CalendarUtil.resolveTime(dateComponents), calculationParameters) ;
  }
...
//    this.calculationParameters = parameters;
    ...
    var date = new DateTime(dateTime.year, dateTime.month, dateTime.day,dateTime.hour, dateTime.minute, dateTime.second);
