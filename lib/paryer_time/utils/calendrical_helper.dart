class CalendricalHelper {
  ...
  static double julianDay(DateTime date) {
    var dateTime = new DateTime(date.year,date.month,date.day,date.minute,date.second);
    return julianDay_y_m_d_h(dateTime.year, dateTime.month , dateTime.day, dateTime.hour + (dateTime.minute / 60.0));
  }
